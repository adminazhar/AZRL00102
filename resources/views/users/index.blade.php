                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-3">We're creating something awesome. Please subscribe to get notified when it's ready!</p>
                               ...
                               <a class="btn btn-primary mb-1 btn-sm-block" href="{{ route('login') }}">Early Beta</a>
                            <img class="img-fluid" src="images/pages/coming-soon.svg" alt="Coming soon page" />
                        </div>
                    </div>
                </div>
                <!-- / Coming soon page-->

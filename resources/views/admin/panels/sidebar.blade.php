            ...
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{route('admin.home')}}">
                    <span class="brand-logo">
                        <img src="{{ URL::asset('/images/logo/logo4.png')}}" height="24">
                    </span>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  {{ (request()->is('admin/home')) ? 'active' : '' }} ">
                <a href="{{route('admin.home')}}" class="d-flex align-items-center" target="_self">
            ...
            <li class=" navigation-header"><span data-i18n="Misc">User Management</span><i data-feather="more-horizontal"></i>
            </li>
            <li class="nav-item  {{ (request()->is('admin/users*')) ? 'active' : '' }}">
                <a href="/admin/users" class="d-flex align-items-center" target="_self">
